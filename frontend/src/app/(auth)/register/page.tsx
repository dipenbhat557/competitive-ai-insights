      ...
      <Card className="w-full max-w-md p-8">
        ...
        <div className="mt-6 space-y-3">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-slate-900/50 px-2 text-slate-500">Or sign up with</span></div>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <a href={`${API_URL}/api/v1/auth/oauth/google`} className="btn-secondary flex items-center justify-center gap-2 text-center">
            ...
            <a href={`${API_URL}/api/v1/auth/oauth/github`} className="btn-secondary flex items-center justify-center gap-2 text-center">
